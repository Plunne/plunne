...
| Logiciels      | *Blender (Impression 3D), CANoe, Confluence, DOORS, Eclipse IDE, ElectroBits Tresos, Entreprise Architect, EMACS, GCC/GDB, Git/Github/Gitlab, IDEAS (Continental Eclispe IDE), Jenkins, JIRA, Keil, KiCAD (Conception PCB), LAMP, Qt Creator, STM32Cube{MX/IDE}, VS/VSCode, Vi/Vim/NeoVim, Vivado, WinIDEA, Wireshark* |
...
**Environement technique :** *C, INFINEON AURIX TC3XX, IDEAS (ECLIPSE IDE), WINIDEA (DEBUG), SWATT, TRESOS, CANOE, JENKINS, DOORS, JIRA, JAZZ, GITHUB, CONFLUENCE, ENTREPRISE ARCHITECT, AGILE, SCRUM, SAFE*
